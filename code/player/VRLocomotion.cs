...
{
	// Most of this class is mostly based on or borrowed from https://github.com/nerd-two/sbox-vrshooter/blob/master/code/Player/VRWalkController.cs
	public class VRLocomotion : BasePlayerController
	{
		...
		public virtual void UpdateBBox()
		{
			...
			EnablePhysics = Input.VR.LeftHand.Joystick.Value.Length > 0.1f;
		}
		...
		private bool SprintWasPressed { get; set; }
		...
		public override void Simulate()
		{
			...
			if ( Host.IsClient )
			{
				if ( Input.VR.LeftHand.JoystickPress.IsPressed && !SprintWasPressed )
				{
					IsSprinting = !IsSprinting;
					ToggleSprinting();
				}

				SprintWasPressed = Input.VR.LeftHand.JoystickPress.IsPressed;
			}
		...
		// TODO: Re-do sprinting so it plays nice with prediction
		private bool IsSprinting { get; set; }

		[ServerCmd]
		public static void ToggleSprinting()
		{
			var instance = ((ConsoleSystem.Caller.Pawn as VRPlayer).Controller as VRLocomotion);
			instance.IsSprinting = !instance.IsSprinting;
		}
